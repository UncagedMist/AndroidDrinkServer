...
public class UpdateCategoryActivity extends AppCompatActivity implements UploadCallbacks {
    ...
    private void deleteCategory() {
        compositeDisposable.add(mService.deleteCategory(
    ...
    private void updateCategory() {
        if (!edt_name.getText().toString().isEmpty()) {
            compositeDisposable.add(mService.updateCategory(
                    Common.currentCategory.getID(),
